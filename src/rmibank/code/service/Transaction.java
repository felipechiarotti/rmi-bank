...
public class Transaction {
	...
	public Transaction(int clientId, int transactionOperation, double value) {
		this.setId();
	...
	public Transaction(int clientId, int transactionOperation, int transactionType, double value) {
		this.setId();
		this.clientId = clientId;
	...
	private void setId() {
		try{
			PgStatement stmt = (PgStatement) Database.getConnection().createStatement();
